      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <p class="text-justify"> A Mogno Engenharia & Consultoria foi fundada em 1985, com o nome de CVJ - Construtora do Vale do Jequitinhonha Ltda, com objetivo de construtora, porém no seu decorrer passou a empresa de consultoria e prestação de serviços nas áreas de projetos e avaliações de engenharia. Em 2014 a CVJ, torna-se Mogno, e seu objetivo firma na área de prestação de serviços de engenharia, e energia solar se torna carro chefe para empresa. Sempre com foco em qualidade e viabilidade econômica.</p>
            <div class="row">
              <div class="col-md-6">
                <h6 class="text-info-def"> Telefone Comercial</h6>
                <h6 class="info">
            ...
            <br />
          <h6 class="text-info-def">Endereço</h6>
          <h6 class="info">
  ...
  <section class="services">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        ...
        <p>Somos uma empresa especializada em diversos serviços e buscamos fazer uso cada vez mais de tecnologias modernas para nossos clientes.</p>
      </div>
      ...
      <div class="row g-5">
        <div class="col-lg-3">
          <div class="text-dark mb-5">
            ...
            <p class="mb-0">Guilherme, responsável técnico pela empresa, é conhecido por atender o seu problema de forma individual buscando melhorias e resoluções que conversem com o seu perfil.</p>
          </div>
          <div class="text-dark">
            <div class="bg-light rounded-pill d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
            ...
            <p class="mb-0">Na nossa empresa, temos uma política de orçamentos e contratos muito clara para deixarmos o trabalho sempre em conformidade com as leis.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
            <p>A Mogno Engenharia e Consultoria está presente no mercado desde 1985 e para se manter sempre ativa e atender as expectativas do mercado, que ficou cada vez mais dinâmico, busca sempre aprender sobre as novas tecnologias e atender cada cliente como sendo único, pois compreende a pluralidade do negócio. Sendo assim, se você busca uma empresa empenhada em resolver os seus problemas voltados para a engenharia e consultoria, com o melhor atendimento personalizado e a melhor infraestrutura, a Mogno Engenharia é a empresa certa para você.</p>
        ...
        <div class="col-lg-3">
          <div class="text-dark mb-5">
            ...
            <p class="mb-0">Temos disponibilidade de visitas técnicas em regiões distantes do escritório oficial.</p>
          </div>
          <div class="text-dark">
            <div class="bg-light rounded-pill d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
            ...
            <p class="mb-0">Através do whatsapp listado aqui no site, você, cliente, pode nos contactuar a hora que quiser que te responderemos com toda a atenção.</p>
          </div>
        </div>
      </div>
    </div>
...
<!--Time de pessoas-->
    ...
    <div class="container">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-6 col-lg-3 text-center team mb-5 ml-4">
          <div class="position-relative overflow-auto mb-4" style="border-radius: 100%">
  ...
  <section id="duvidas" class="faq section-bg">
    ...
    <!--Contato-->
  <div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5" id="contato">
    <div class="row pt-5">
      <div class="col-lg-3 col-md-6 mb-5">
        ...
        <p> Nos acompanhe nas redes sociais, Mogno Engenharia e Consultoria sempre com você.</p>
        <div class="d-flex justify-content-start mt-4">
          <a class="btn btn-outline rounded-circle text-center mr-2 px-0 redes" style="width: 38px; height: 38px" href="https://www.facebook.com/guilhermesaleseng/" target="blank">
            <i class="bi bi-facebook"></i>
          </a>
          <a class="btn btn-outline rounded-circle text-center mr-2 px-0 redes" style="width: 38px; height: 38px" href="https://www.linkedin.com/in/mogno-engenharia-e-consultoria-ltda-gerenciamento-de-projetos-4171b5230" target="blank">
            <i class="bi bi-linkedin"></i>
          </a>
          <a class="btn btn-outline rounded-circle text-center mr-2 px-0 redes" style="width: 38px; height: 38px" href="https://www.instagram.com/mogno_engenhariacivil/" target="blank">
            <i class="bi bi-instagram"></i>
          </a>
          <a class="btn btn-outline rounded-circle text-center mr-2 px-0 redes" style="width: 38px; height: 38px"href="https://wa.link/7k0lbn" target="blank">
    ...
    <div class="container-fluid pt-5" style="border-top: 1px solid #334020;">
      <p class="m-0 text-center text-white">
      &copy; Mogno Engenharia & Consultoria . Todos os direitos reservados.
      </p>
    </div>
  </div>
